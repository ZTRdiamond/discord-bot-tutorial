...
var _Block_content, _Block_children, _Block_parent;
Object.defineProperty(exports, "__esModule", { value: true });
class Block {
    constructor(input) {
        _Block_content.set(this, void 0);
        _Block_children.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _Block_children, [], "f");
    ...
    addChild(child) {
        __classPrivateFieldGet(this, _Block_children, "f").push(child);
    }
    setParent(parent) {
    ...
    get children() {
        return __classPrivateFieldGet(this, _Block_children, "f");
    }
    get splits() {
...
_Block_content = new WeakMap(), _Block_children = new WeakMap(), _Block_parent = new WeakMap();
